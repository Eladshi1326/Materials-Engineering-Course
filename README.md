...
| **230 נוסחאות** | עם פירוט המשתנים והערות שימוש |
...
- **משחק התאמה** — מונח ↔ הגדרה, נגד השעון, עם ניקוד ושיא אישי
- **אתגר מהיר** — שאלות קשות, 30 שניות לשאלה, 3 חיים
- **5 מבחני יחידה** — 20 שאלות כל אחד
- **מבחן הסמכה** — 50 שאלות מכל הספר → תעודה מודפסת

### מערכת ההתקדמות
- **נעילת פרקים**: פרק *N* נפתח רק אחרי **75+** במבחן פרק *N−1*
- **מבחן יחידה** נפתח כשכל פרקי היחידה עברו; **מבחן ההסמכה** — כשכל 22 עברו (מעבר: 80)
...
- ייצוא/ייבוא התקדמות כ-JSON בהגדרות. רוצה לדלג על הנעילה? הגדרות → **מצב חופשי**
