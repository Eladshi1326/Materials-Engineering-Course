...
| **741 שאלות** | 590 למבחנים + 151 לתרגול המדורג — עם הסברים, רמזים ומסיחים באורך מאוזן |
| **32 איורים** | דיאגרמות SVG מקוריות בתוך הסעיפים: מבנים גבישיים, דיאגרמות פאזה, עקומות מאמץ-מעוות ועוד |
...
- **תרגול מדורג** — קל ← בינוני ← קשה: תיאוריה, הגדרות ושאלות חישוב עם הנוסחאות, בלי טיימר
...
- **מבחן מסכם** — 50 שאלות מכל הספר

### מערכת ההתקדמות
- **הפרקים פתוחים תמיד** — המסלול המומלץ הוא לפי הסדר, ופרק נחשב "הושלם" אחרי **75+** במבחן שלו
- **מבחני היחידה והמבחן המסכם** נפתחים עם השלמת הפרקים הרלוונטיים; מי שרוצה יכול לפתוח מוקדם עם "פתח בכל זאת" (מעבר: 80)
