  ...
  return (
    <>
      <section className="hero">
        ...
        <p>
          קורס מלא בעברית על מדע והנדסת חומרים. שיעורים מעמיקים, מבחנים עם הסברים, כרטיסיות,
          משחקי התאמה ואתגרי מהירות — עם מסלול נעילה שמכריח אותך לשלוט בכל פרק לפני שממשיכים הלאה.
        </p>
